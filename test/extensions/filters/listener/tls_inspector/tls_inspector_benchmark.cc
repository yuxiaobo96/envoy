...
public:
  Event::FileEventPtr createFileEvent(SOCKET_FD, Event::FileReadyCb cb, Event::FileTriggerType,
                                      uint32_t) override {
...
public:
  ...
  Api::SysCallSizeResult recv(SOCKET_FD, void* buffer, size_t length, int) override {
